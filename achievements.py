...
BADGES = [
    # Corrida acumulada
    Badge("run10", "🏃", "Aquecendo", "10 km de corrida acumulados", "run_km", 10),
    Badge("run100", "🏃‍♂️", "Centurião", "100 km de corrida acumulados", "run_km", 100),
    Badge("run500", "🏆", "Maratonista de elite", "500 km de corrida acumulados", "run_km", 500),
    # Natação acumulada
    Badge("swim10", "🏊", "Peixe", "10 km nadados", "swim_km", 10),
    Badge("swim50", "🐬", "Golfinho", "50 km nadados", "swim_km", 50),
    # Maior corrida única (distância de um treino)
    Badge("long5", "✅", "Primeiros 5K", "Uma corrida de 5 km", "max_run", 5),
    Badge("long10", "🔟", "Dez de uma vez", "Uma corrida de 10 km", "max_run", 10),
    Badge("half", "🥈", "Meia-maratona", "Uma corrida de 21 km", "max_run", 21.0975),
    Badge("full", "🥇", "Maratona", "Uma corrida de 42 km", "max_run", 42.195),
    # Sequência
    Badge("streak7", "🔥", "Uma semana firme", "7 dias seguidos treinando", "max_streak", 7),
    Badge("streak30", "⚡", "Imparável", "30 dias seguidos treinando", "max_streak", 30),
    # Volume de treinos
    Badge("count50", "💪", "Constante", "50 treinos registrados", "count", 50),
    Badge("count200", "🌟", "Veterano", "200 treinos registrados", "count", 200),
    # Energia
    Badge("cal50k", "🔋", "Usina", "50.000 kcal queimadas", "cal", 50000),
]
